...
{
    /// <summary>
    ///     Automapper profile to map Trade to TradesByAccountQ3
    /// </summary>
    public class TradesByAccountQ3Mapper : Profile
    {
        public TradesByAccountQ3Mapper()
        {
            CreateMap<Trade, TradesByAccountQ3>()
