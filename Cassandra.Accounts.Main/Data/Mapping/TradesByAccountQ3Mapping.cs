...
{
    /// <summary>
    ///     Cassandra configuration mapping for the table trades_by_a_td
    /// </summary>
    public class TradesByAccountQ3Mapping : Cassandra.Mapping.Mappings
    {
        /// <summary>
        ///     Creates an instance of <see cref="TradesByAccountQ3Mapping"/> initializing the cassandra data model configuration mapping
        /// </summary>
        public TradesByAccountQ3Mapping()
        {
            For<TradesByAccountQ3>()
            .TableName("trades_by_a_td")
